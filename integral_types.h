// Taken https://github.com/google/or-tools/blob/v8.2/ortools/base/integral_types.h
// For some reason, OpenFST needs this, but only when regenerating the Cython build files.
